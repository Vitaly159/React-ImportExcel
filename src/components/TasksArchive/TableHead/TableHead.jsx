...
import { Histiry_dt } from "./Сolumns/Histiry_dt";
...
export const TableHead = ({setFilterOn, setMassive, excelData}) => {
  ...
  const [histiry_dt, setHistiry_dt] = useState('Все');

  const allSets = [setIdArray, setDeadline_time, setTask_id, setOwner,
    setStatus, setStatus_dt, setTask_name, setWeek_day, setHistiry_dt
  ];
    ...
    <thead>
      <tr>
        ...
        <Histiry_dt 
          ...
          setMassive={setMassive}
          allSets={allSets}
          setHistiry_dt={setHistiry_dt}
          histiry_dt={histiry_dt}
        />
      </tr>
    </thead>
  )
